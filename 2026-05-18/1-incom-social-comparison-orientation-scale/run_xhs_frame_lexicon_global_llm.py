...
USER_PROMPT_TEMPLATE = """下面是基于社会比较理论和 XHS 语料构建的 frame-level lexicon。请把它当作上下文证据，不要机械匹配关键词。
...
def main() -> None:
    ...
    api_key = args.api_key or os.getenv("NEWAPI_API_KEY") or os.getenv("OPENAI_API_KEY") or ""
